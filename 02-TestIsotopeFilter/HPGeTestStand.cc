...
G4VPhysicalVolume *HPGeTestStand::DefineGeometry() {
  ...
  auto world_l = new G4LogicalVolume(world_s, Gdwater, "WorldLAr");
  ...
  // Place PMTs
  new G4PVPlacement(nullptr, G4ThreeVector(+3. * spacing, +3. * spacing, 0),
                    pmt_l, "PMT1", world_l, false, 0);
  new G4PVPlacement(nullptr, G4ThreeVector(+3. * spacing, -3. * spacing, 0),
                    pmt_l, "PMT2", world_l, false, 0);
  new G4PVPlacement(nullptr, G4ThreeVector(-3. * spacing, +3. * spacing, 0),
                    pmt_l, "PMT3", world_l, false, 0);
  new G4PVPlacement(nullptr, G4ThreeVector(-3. * spacing, -3. * spacing, 0),
                    pmt_l, "PMT4", world_l, false, 0);
  ...
  G4LogicalSkinSurface *PMTSkinSurface =
      new G4LogicalSkinSurface("PMTSkinSurface", pmt_l, PMTsurface);
